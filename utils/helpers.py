...
def phase_schedualer(max_iters, phase1_end, phase2_end, lerp_steps, max_imi_weight):
    ...
    imitation_schedual[phase1_end : phase1_end + lerp_steps] = np.arange(
        0, max_imi_weight, step_by_value
    )
    imitation_schedual[phase1_end + lerp_steps : phase2_end] = max_imi_weight
    imitation_schedual[phase2_end : phase2_end + lerp_steps] = np.arange(
        max_imi_weight, 0, -step_by_value
    )
